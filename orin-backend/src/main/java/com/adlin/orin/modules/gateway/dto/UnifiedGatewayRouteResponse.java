...
@NoArgsConstructor
@AllArgsConstructor
public class UnifiedGatewayRouteResponse {
    ...
    public static UnifiedGatewayRouteResponse fromEntity(UnifiedGatewayRoute entity) {
        return UnifiedGatewayRouteResponse.builder()
                .id(entity.getId())
                .name(entity.getName())
