<template>
  <div class="admin-layout main-layout">
    <!-- 顶部导航栏 -->
    <TopNavbar
      v-if="appStore.menuMode === 'topbar'"
      :menus="visibleMenus"
      surface-label="ORIN 管理台"
      :profile-route="profileRoute"
      :home-route="ROUTES.ADMIN"
    />
...
const profileRoute = computed(() => ROUTES.ADMIN_PATHS.PROFILE)

const visibleMenus = computed(() => buildVisibleMenus(ADMIN_MENU, userStore.roles || []))
</script>
