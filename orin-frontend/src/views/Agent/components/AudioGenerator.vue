  ...
  <div class="playground-stage">
    ...
    <div class="canvas-container">
      <div class="canvas-inner" :class="{ 'has-audio': audioUrl && !isProcessing }">
        ...
        <!-- Result Canvas -->
        <div v-if="audioUrl && !isProcessing" class="result-canvas">
          <div class="audio-player-wrapper">
            <div ref="waveformContainer" class="waveform-container" @click="handleSeek">
...
.chat-textarea :deep(.el-textarea__inner) { min-height: 86px !important; border: none; box-shadow: none; padding: 20px; font-size: 15px; line-height: 1.5; background: transparent; }
...
.generate-btn { min-width: 126px; padding: 10px 24px; border-radius: 12px; font-weight: 700; background: #0d9488 !important; border: none !important; box-shadow: 0 4px 10px rgba(13, 148, 136, 0.3); }
