...
for service in mysql redis rabbitmq orin-backend orin-ai-engine orin-frontend; do
...
require_text "$COMPOSE" "      ORIN_RABBITMQ_LISTENERS_AUTO_STARTUP: \"true\"" "backend.rabbitmq-listener"
require_text "$COMPOSE" "      ORIN_DEFAULT_ADMIN_PASSWORD:" "backend.default-admin-password"
